                    ...
                    return(
                        ...
                        <tr>
                          <td>  <NavLink to={`/Account?name=${value.email}`} state={{Profile_click:"yes", selected: selectedComponent }}  style={{ textDecoration: 'none',  color: "#11297f" }}> 
                            ...
                            <td> 
                                <NavLink to={`/Account?name=${value.email}`} state={{Profile_click:"yes", selected: selectedComponent}} style={{ textDecoration: 'none',  color: "#11297f" }}><b>{name}</b> </NavLink> on<br/>
                                <NavLink to={`/${value.language_id}/${value.level_id}/discussion?discussionId=${value.id}`} state={{ selected:selectedComponent}}  style={{ textDecoration: 'none',  color: "#11297f" }}>
                                    <b>  {value.title}</b><br/>
                                        {a}
                                </NavLink>
                      ...
                      {recentsave?.map((value,index)=>{
                          ...
                          return(
                              ...
                              <td>  <NavLink to={`/Account?name=${value.email}`} state={{ Profile_click: "yes" }} style={{ textDecoration: 'none',  color: "#11297f" }}> 
                                  ...
                                  <td> 
                                    <NavLink to={`/Account?name=${value.email}`} state={{ Profile_click: "yes" }} style={{ textDecoration: 'none',  color: "#11297f" }}><b>{name}</b> </NavLink> on<br/>
                                      <NavLink to={`/${value.language_id}/${value.level_id}/discussion?discussionId=${value.id}`}  state={{ selected:selectedComponent}}  style={{ textDecoration: 'none',  color: "#11297f" }}>
                                          <b>  {value.title} </b><br/>
                                              {a}
                                      </NavLink>
